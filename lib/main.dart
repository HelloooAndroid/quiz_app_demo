...
import 'package:quiz_app_demo/courses/CoursesBloc.dart';
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      ...
      body: RefreshIndicator(
        onRefresh: () => _bloc.fetchCoursesList(context),
              ...
              switch (snapshot.data.status) {
                ...
                case Status.ERROR:
                  return Error(
                    ...
                    onRetryPressed: () => _bloc.fetchCoursesList(context),
                  );
                  break;
              }
            }
            ...
            child: Padding(
              ...
              child: ListTile(
                ...
                onTap: () {
                  Navigator.push(
                      context,
                      MaterialPageRoute(builder: (context) => QuestionPage(/*coursesList.courses[index].course_name*/))
                  );
                },
              ),
            ),
